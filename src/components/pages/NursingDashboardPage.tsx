...
export default function NursingDashboardPage() {
  ...
  const colorMap = {
    ...
    error: { bg: 'bg-attention/10', text: 'text-error', icon: 'text-red-950', bgIcon: 'bg-red-300' },
  };
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                ...
                { label: 'Avaliados pelo Médico', value: stats.evaluatedByDoctor, icon: ClipboardCheck, colorKey: 'primary', filterId: 'AVALIADO_MEDICO' as FilterType },
              ].map((stat, index) => {

          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                ...
                { label: 'Encaminhados ao Médico', value: stats.referredToDoctor, icon: CheckCircle, colorKey: 'attention', filterId: 'ENCAMINHADO_MEDICO' as FilterType },
                ...
                { label: 'Avaliados pelo Médico', value: stats.evaluatedByDoctor, icon: CheckCircle, colorKey: 'primary', filterId: 'AVALIADO_MEDICO_COMPLETO' as FilterType },
              ].map((stat, index) => {
